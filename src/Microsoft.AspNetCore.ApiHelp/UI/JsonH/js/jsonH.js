    ...
    var _pub_static = function (sJson) {
        ...
        _main = function () {
            ...
            var iSI = setInterval(function () {
                ...
                } catch (e) { alert(e); clearInterval(iSI); }
            }, 500);
            ...
            $(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        _pub.customSetTree(data);
                        _pri.uiEvtCallback.clickCollapseAll();
                    },
                    error: function (data) {
                        console.log(data);
                    }
        ...
        JH.mergePropertyFrom(_pri, {
            ...
            "showAdTips": function () {
                _pri.getJhData(function (oResp) {
                    $(_pri.node.rcmd).addClass('tips').empty().append('<a href="' + oResp.data.jhPath + '../options.html#ad" target="_blank" class="adHelp langID_msg_11">？' + _pri.oLang.getStr('msg_11') + '</a>');
                });
            },
            "showAd": function (oAd) {
        ...
        JH.mergePropertyFrom(_pub, {
            ...
            "customSetTree": function (json) {
                _pri.hasError = false;
                //创建格式数据
                _pro.oTreeNav.build(json);
                return false;
            }
        });
